...
<head>
    ...
    <title>Perishable Shop - Products</title>
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-custom active" href="/user/products">Products</a>
                </li>
                <li class="nav-item">
    ...
    <div class="glass-panel p-4" style="overflow-x: auto;">
            ...
            <tbody>
                <c:forEach var="product" items="${products}">
                    <tr>
                        ...
                        <td>
                            <img class="img-preview" src="${product.image}" alt="${product.name}" height="60px" width="60px">
                        </td>
                        ...
                        <td style="max-width: 250px;" class="text-secondary text-truncate">${product.description}</td>
                        <td class="text-center">
                            <form action="/cart/add" method="post" class="m-0">
                                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                <input type="hidden" name="id" value="${product.id}">
                                <button type="submit" class="btn btn-primary-custom btn-sm py-2 px-3">
        ...
        <c:if test="${empty products}">
            <div class="text-center py-5">
                ...
                <h4 class="text-secondary">${msg != null ? msg : 'No products found'}</h4>
            </div>
        </c:if>
    </div>
</main>
